...
loginSubmit.addEventListener("click", function (e) {
  ...
  if (userName.value === "" || password.value === "" ) {
    ...
    if (userName.value.trim() === "mahmoudAli22" && password.value === "0722" || userName.value.trim() === "Mostafa Mahmoud" && password.value === "66123455" || userName.value.trim() === "Saleh.26" && password.value === "2680" || userName.value.trim() === "Haidy.mahmoud" && password.value === "00022" || userName.value.trim() === "abdeLrhman" && password.value === "4532" || userName.value.trim() === "totySalem" && password.value === "8630" || userName.value.trim() === "nermeenN" && password.value === "5801" || userName.value.trim() === "Mohamed.Emam" && password.value === "12345" || userName.value.trim() === "Hassan" && password.value === "8350" || userName.value.trim() === "Omar" && password.value === "0756" || userName.value.trim() === "Mostafa.Eid" && password.value === "7396") {
